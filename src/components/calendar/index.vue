<template>
    <div class="calendar-container">
        ...
        <ul class="date">
            ...
            <li @click="clickEvent" v-for="day in nowMonthDays" :key="day" :class="[selectDateInfo.day == day? 'select-day': '']"><span>{{day}}</span></li>
